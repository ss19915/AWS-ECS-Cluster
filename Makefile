...
AUTO_SCALING_GROUP_NAME = ${PROJECT}-AlbGroup-${ENVIRONMENT}

deploy:
	@${MAKE} createEcs --no-print-directory
	@${MAKE} createTask --no-print-directory

deleteAll:
	@${MAKE} deleteTask --no-print-directory
	@${MAKE} deleteEcs --no-print-directory
